...
# commmented out lines are for AMOS batch processing (not used in demo)
...
# sshpass -p "${ENM_AMOS_PASSWORD}" ssh ${ENM_AMOS_USERNAME}@${ENM_AMOS_IP} "amosbatch -w 1 -p 30 -t 10 \"/home/shared/${ENM_AMOS_USERNAME}/.Teal/sitelist.txt\" \"lt all;rbs;rbs;st cell;st rru;st mme;st ike;pmxet . radioRecInterferencePucchPwr$;ue print -admitted;invxrf;get . configuredMaxTxPower;alt;get gps;get gnss\" \"/home/shared/${ENM_AMOS_USERNAME}/.Teal/TealLogs\""
